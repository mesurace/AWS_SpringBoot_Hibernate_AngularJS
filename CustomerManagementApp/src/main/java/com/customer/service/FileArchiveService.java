...
import com.customer.exception.FileArchiveServiceException;
...
public class FileArchiveService {
	 ...
	 * @throws IOException
	 */
	public Image saveFileToS3(MultipartFile multipartFile) throws FileArchiveServiceException {
		...
		try{
			...
			return new Image(key, signedUrl.toString());
		}
		catch(Exception ex){			
	 ...
	 * @param customerImage
	 */
	public void deleteImageFromS3(Image customerImage){
